  ...
  <div id="wrapper">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="?action=kho&view=nhatkyxuat">Nhật ký Xuất Kho</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages1" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header"></h6>
            <a class="collapse-item" href="?action=sanpham">Danh Sách sản phẩm</a>
            <a class="collapse-item" href="?action=sanpham&view=themsp">Thêm sản phẩm </a>
            <a class="collapse-item" href="?action=mau&view=them">Thêm màu</a>
            <a class="collapse-item" href="?action=size&view=them">Thêm size</a> 
          </div>
        </div>
      </li>
