...
<div class="container-fluid">
	<div class=" alert alert-primary">
	  <h4 class="page-title">
	    ...
	    </span> ADMIN - ART &#160;<i class="fas fa-chevron-right" style="font-size: 18px"></i>&#160; Nhân Viên</h4>
	</div><br>
	<div class="card">
		<div class="card-body">
			 ...
			 <?php $so=0;
				 while ($row=mysqli_fetch_array($rs)) { ?>
					<tr>
						...
						<td><a href="index.php?action=nhanvien&view=sua&manv=<?php echo $row['MaNV']; ?>" ><i class="mdi mdi-dns"></i></a></td>
						<td><a href="nhanvien/xuly.php?xoa&manv=<?php echo $row['MaNV']; ?>" ><i class="mdi mdi-dns"></i></a></td>	
					</tr>
			 <?php	} ?>		
				</tbody>
			</table><hr>
