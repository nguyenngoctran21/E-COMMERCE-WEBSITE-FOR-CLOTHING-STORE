...
<div class="container-fluid">
    <div class=" alert alert-primary">
      <h4 class="page-title">
        ...
        </span> ADMIN - ART &#160;<i class="fas fa-chevron-right" style="font-size: 18px"></i>&#160; Khuyến mãi&#160;<i class="fas fa-chevron-right" style="font-size: 18px"></i>&#160; Apply &#160;<i class="fas fa-chevron-right" style="font-size: 18px"></i>&#160; <?php echo $kq['TenKM'] ?></h4>
    </div>
</div>
...
if(isset($_POST['btsearch'])){
	...
	<div class="card card-body">
		<table class="table-hover table text-center">
			<thead>
				<tr class="badge-info">
						<th>Mã Sản Phẩm</th><th>Tên Sản Phẩm</th><th>Thương hiệu</th><th>Đơn Giá</th><th  class="badge-danger" >chọn 1</th>
...
<form action="khuyenmai/xuly.php" method="get" accept-charset="utf-8" class="container-fluid">
	<div class="card card-body">
		<table class="table-hover table text-center">
			<thead>
				<tr class="badge-info">
						<th>Mã Sản Phẩm</th><th>Tên Sản Phẩm</th><th>Thương hiệu</th><th>Đơn Giá</th>
						<th   >chọn 1</th>
						<th  class="badge-light" >	
							<input class="btn btn-outline-primary" type="button" id="btn1" value="tất cả"/>
       						<input class="btn btn-outline-dark" type="button" id="btn2" value="Hủy"/>
