<?php
	$sql="select * from hoadon  where (TinhTrang ='đang vận chuyển' or TinhTrang ='hoàn thành')  Order by NgayDat DESC ";
...
<div class="container-fluid">
	<div class="page-header">
	  <h4 class="page-title">
	    ...
	    </span> ADMIN - ART &#160;<i class="fas fa-chevron-right" style="font-size: 18px"></i>&#160; Kho Hàng &#160;<i class="fas fa-chevron-right" style="font-size: 18px"></i>&#160; Xem Đơn Hàng</h4>
	</div><hr><br>
	<div class="row">
				...
				<tbody>
				 	...
				 	while ($row=mysqli_fetch_array($rs)) { ?>
						<tr>
							...
							<td><?php if ($row['TinhTrang']==='Đang Vận Chuyên') {?>
