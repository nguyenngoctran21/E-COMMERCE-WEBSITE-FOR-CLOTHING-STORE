...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
		...
		<div class="col-12">
			<center>
				<!-- <button href="index.php?action=danhmuc&view=suadm&madm=" type="sub" name="dk" value="đã duyệt"class="btn btn-primary" style="font-family: Comfortaa;">In hóa Đơn</button> -->
				<?php
				// Xử lý sự kiện khi nút được bấm
				if (isset($_POST['chuyen_trang'])) {
					// Thực hiện các xử lý cần thiết trước khi chuyển trang
					// Ví dụ: lưu dữ liệu vào CSDL, thực hiện tính toán, ...
					
					// Chuyển hướng sang trang khác
					header("Location: danhthu/inhoadon.php");
					exit(); // Đảm bảo ngừng thực thi script sau khi chuyển trang
				}
				?>

				<!-- Form với nút bấm -->
				<form method="post">
					<input type="submit" name="chuyen_trang" value="in hóa đơn">
				</form>
			</center>
		</div>
