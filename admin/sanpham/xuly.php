...
if(isset($_POST['xlsua'])){
	...
	if(isset($_GET['xoa'])){
		$masp=$_GET['masp'];
			$delete="DELETE FROM `binhluan` WHERE MaSP = $masp";
			$rs_d=mysqli_query($conn,$delete);
		if(isset($rs_d)){
			$delete2="DELETE FROM `chitiethoadon` WHERE MaSP = $masp";
			$rs_d2=mysqli_query($conn,$delete2);
		if(isset($rs_d2)){
			$delete3="DELETE FROM `phieunhap` WHERE MaSP = $masp";
			$rs_d3=mysqli_query($conn,$delete3);
		if(isset($rs_d3)){
			$delete4="DELETE FROM `chitietsanpham` WHERE MaSP = $masp";
			$rs_d4=mysqli_query($conn,$delete4);
		if(isset($rs_d4)){
			$delete5="DELETE FROM `sanpham` WHERE MaSP = $masp";
			$rs_d5=mysqli_query($conn,$delete5);
		if(isset($rs_d5)){
			$delete6="DELETE FROM `anhsp` WHERE MaSP = $masp";
			$rs_d6=mysqli_query($conn,$delete6);
		if(isset($rs_d6)){
			$delete7="DELETE FROM `sanphamkhuyenmai` WHERE MaSP = $masp";
			$rs_d7=mysqli_query($conn,$delete7);
		if(isset($rs_d7)){
