...
<div class="container-fluid">
	...
	<table class="table table-hover m-auto text-center" style="font-size: 13px;">
		<thead class="badge-info">
			<tr>
				<th>Ảnh Nền</th><th>Mã Sản Phẩm</th> <th>Tên Sản Phẩm</th><th>Mã Danh Mục</th><th>Mã nhà cung cấp</th><th>Số lượng</th><th>Mô tả</th><th>Đơn Giá</th><th>Sửa</th><th>Xóa</th>
	 ...
	 <?php $so=0;
		 while ($row=mysqli_fetch_array($rs)) { ?>
			<tr>
				...
				<td><a href="index.php?action=sanpham&view=suasp&masp=<?php echo $row['MaSP']; ?>" ><i class="mdi mdi-dns"></i></a></td>
				<td><a href="sanpham/main.php?view=xoasp&masp=<?php echo $row['MaSP']; ?>" ><i class="mdi mdi-dns"></i></a></td>
			</tr>	
			</tr>
	 <?php	} ?>
