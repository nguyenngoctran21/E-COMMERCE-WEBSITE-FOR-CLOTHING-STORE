...
<div class="container-fluid">
	<div class=" alert alert-primary">
	  <h4 class="page-title">
	    ...
	    </span> ADMIN - ART &#160;<i class="fas fa-chevron-right" style="font-size: 18px"></i>&#160; Danh Mục</h4>
	</div><br>
	 ...
	 <?php $so=0;
		 while ($row=mysqli_fetch_array($rs)) { ?>
			<tr>
				...
				<td><a href="index.php?action=danhmuc&view=suadm&madm=<?php echo $row['MaDM']; ?>" ><i class="mdi mdi-dns"></i></a></td>
				<td><a href="danhmuc/main.php?view=xoadm&madm=<?php echo $row['MaDM']; ?>" ><i class="mdi mdi-dns"></i></a></td>
			</tr>
	 <?php	} ?>
